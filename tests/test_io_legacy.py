...
from upsilonconf.config import CarefulConfiguration
from upsilonconf.io import *

DEFAULT_NAME = DirectoryIO.DEFAULT_NAME

# TODO: discard or transfer original CLI tests (after fixing interface)


CONFIG = CarefulConfiguration(foo=1, bar="baz", baz={"a": 0.1, "b": 0.2})
CONFIG_JSON_LINES = (
    "{",
    '  "foo": 1,',
    '  "bar": "baz",',
...
class TestCLI(TestCase):
    def _as_dot_keys(self, config: CarefulConfiguration):
    ...
    def test_from_cli_config_file(self):
        ...
        m_open.assert_called_once_with(path, "r", encoding="utf-8")
